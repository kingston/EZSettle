...
$_SESSION['chatNew'] = array(
	array('speaker' => 'Mediator', 'message' => 'In this process, {if $condition == 1 || $condition == 2 || $condition == 5}the system{else}I{/if} would like to address the concerns that you and
