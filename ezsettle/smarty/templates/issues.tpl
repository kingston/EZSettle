...
<div class="main_body">
	...
	<div class="prepend-1 span-8 append-2 last">
		...
		<div style="display:none;" id="more_issues">
			...
			<div id="issues_added" style="display:none;" class="notice span-6">Unfortunately, the system cannot process additional issues at this time. <a href="issues2.php">Click here to continue</a></div>
		</div>
	</div>
	</div>
