...
<div class="main_body">
	...
	<div class="quiet box hide" id="a4">Anywhere. If you have an internet connection, you can access the EZSettle system. EZSettle is compatible with every modern (HTML5 compliant) web browser.</div></li>
			...
			<li><div class="loud q" id="5">What is a “Claimant”?&nbsp;&nbsp;&nbsp;<span id="arrow5"><img src="images/arrowdown.png"/></span></div>
	<div class="quiet box hide" id="a5">The Claimant is the party initiating the case. The Claimant may be either a buyer or a seller.</div></li>
		...
		<li><div class="loud q" id="6">What is a "Respondent" &nbsp;&nbsp;&nbsp;<span id="arrow6"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="7">Can EZSettle generate efficient solutions? &nbsp;&nbsp;&nbsp;<span id="arrow7"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="8">What is mediation? &nbsp;&nbsp;&nbsp;<span id="arrow8"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="12">What happens if no agreement is reached? &nbsp;&nbsp;&nbsp;<span id="arrow12"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="13">Can I retract an offer after I submit it? &nbsp;&nbsp;&nbsp;<span id="arrow13"><img src="images/arrowdown.png"/></span></div>
	<div class="quiet box hide" id="a13">No. Once an offer is made in the EZSettle system, it is considered a legal contract.</div></li>

	<li><div class="loud q" id="14">Are EZSettle transactions secure? &nbsp;&nbsp;&nbsp;<span id="arrow14"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="15">Do I have to accept one of the other party’s offers? &nbsp;&nbsp;&nbsp;<span id="arrow15"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="16">Is EZSettle really a neutral party? &nbsp;&nbsp;&nbsp;<span id="arrow16"><img src="images/arrowdown.png"/></span></div>
	<div class="quiet box hide" id="a16">EZSettle is private and independent. It is not an agent or representative of any sponsor or party using the system.</div></li>
		...
		<li><div class="loud q" id="17">What does EZSettle cost? &nbsp;&nbsp;&nbsp;<span id="arrow17"><img src="images/arrowdown.png"/></span></div>
	...
	<li><div class="loud q" id="17">What technical support is available? &nbsp;&nbsp;&nbsp;<span id="arrow17"><img src="images/arrowdown.png"/></span></div>
