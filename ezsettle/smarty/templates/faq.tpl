...
<div class="main_body">
	...
	<ol class="faq">
	<li><div class="loud q" id="1">What is Online Dispute Resolution (ODR)? &nbsp;&nbsp;&nbsp;<span id="arrow1">↓</span></div>
	...
	<li><div class="loud q" id="2">How do I use the EZSettle system? &nbsp;&nbsp;&nbsp;<span id="arrow2">↓</span></div>
	...
	<li><div class="loud q" id="3">When can I access the system? &nbsp;&nbsp;&nbsp;<span id="arrow3">↓</span></div>
		<div class="quiet box hide" id="a3">Anytime. The EZSettle system is always accessible.</div></li>
	
	<li><div class="loud q" id="4">From where can I access the system? &nbsp;&nbsp;&nbsp;<span id="arrow4">↓</span></div>
	...
	<li><div class="loud q" id="5">Does EZSettle require a party to reveal preference information to another party?<span id="arrow5">↓</span></div>
	...
	<li><div class="loud q" id="6">What is mediation? &nbsp;&nbsp;&nbsp;<span id="arrow6">↓</span></div>
	...
	<li><div class="loud q" id="7">What is arbitration? &nbsp;&nbsp;&nbsp;<span id="arrow7">↓</span></div>
	...
	<li><div class="loud q" id="8">Can EZSettle generate efficient solutions? &nbsp;&nbsp;&nbsp;<span id="arrow8">↓</span></div>
	...
	<li><div class="loud q" id="9">What happens if no agreement is reached? &nbsp;&nbsp;&nbsp;<span id="arrow9">↓</span></div>
	...
	<li><div class="loud q" id="10">Can I retract an offer after I submit it? &nbsp;&nbsp;&nbsp;<span id="arrow10">↓</span></div>
	<div class="quiet box hide" id="a10">No. Once an offer is made in the EZSettle system, it is considered a legal contract.</div></li>

	<li><div class="loud q" id="11">Are EZSettle transactions secure? &nbsp;&nbsp;&nbsp;<span id="arrow11">↓</span></div>
	...
	<li><div class="loud q" id="12">Do I have to accept one of the other party’s offers? &nbsp;&nbsp;&nbsp;<span id="arrow12">↓</span></div>
	...
	<li><div class="loud q" id="13">Is EZSettle really a neutral party? &nbsp;&nbsp;&nbsp;<span id="arrow13">↓</span></div>
	...
	<li><div class="loud q" id="14">What technical support is available? &nbsp;&nbsp;&nbsp;<span id="arrow14">↓</span></div>
